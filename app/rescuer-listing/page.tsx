          ...
          <div style={{ width: '100%', maxWidth: '540px' }}>
            ...
            {photos.length === 0 && (
              <div className="upload-area" onClick={() => fileInputRef.current?.click()}>
                <div className="upload-icon" style={{ color: 'var(--accent-soft)' }}><Camera size={48} strokeWidth={1.5} /></div>
              ...
              <div className="col-right">
                ...
                <div className="section">
                  <div style={{ display: 'flex', alignItems: 'center', justifyContent: 'space-between', marginBottom: '10px' }}>
                    ...
                    <button onClick={() => setStep(1)} style={{ background: 'none', border: 'none', fontSize: '12px', color: 'var(--accent-soft)', fontWeight: 600, cursor: 'pointer' }}>+ Add more</button>
                  </div>
